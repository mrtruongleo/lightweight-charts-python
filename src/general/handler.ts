...
export class Handler {
  ...
  private _createChart() {
    ...
    return createChart(this.div, options);
  }
  ...
  createCandlestickSeries() {
    ...
    const candleSeries = this.chart.addSeries(CandlestickSeries, options);
  ...
  createVolumeSeries() {
    ...
    const volumeSeries = this.chart.addSeries(HistogramSeries, options);
  ...
  createLineSeries(
    name: string,
    options: DeepPartial<LineSeriesOptions & SeriesOptionsCommon>
  ) {
  ...
  createHistogramSeries(
    name: string,
    options: DeepPartial<HistogramSeriesOptions & SeriesOptionsCommon>
  ) {
